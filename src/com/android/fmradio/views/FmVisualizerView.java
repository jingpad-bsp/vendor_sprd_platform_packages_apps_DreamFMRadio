...
public final class FmVisualizerView extends View {
    ...
    private float mColumnPadding = 1f;

    private boolean mAnimate = false;

    private int mFrequency = 100;

    private static final int COLUME_PADDING_COUNTS = 4;

    private static final int COLUME_COUNTS = 5;

    private static final float[] DEFALT_VISUALIZER_LEVEL = new float[] {
            +0.4f, 1f, -0.2f,0.3f,-0.3f
    };
