...
public class FmStation {
    ...
    public static final class Station implements BaseColumns {
        ...
        /**
         * If this station is show, IS_SCAN : show   IS_NOT_SCAN : hide
         *
         */
        public static final int IS_SCAN = 1;
        public static final int IS_NOT_SCAN = 0;
        ...
        /**
         * If this station is show, it is 1, otherwise 0
         * <P>
         * Type: INTEGER (boolean)
         * </P>
         */
    ...
    public static void insertStationToDb(Context context, int frequency, String stationName, int isShow) {
        ContentValues values = new ContentValues(2);
        values.put(Station.FREQUENCY, frequency);
        values.put(Station.STATION_NAME, stationName);
        values.put(Station.IS_SHOW, isShow);
        context.getContentResolver().insert(Station.CONTENT_URI, values);
        context.getContentResolver().notifyChange(FmStation.Station.CONTENT_URI, null);
    }
     ...
     */
    public static int updateStationToDb(Context context, int frequency, String stationName) {
        final int size = 1;
     ...
     */
    public static int updateStationToDb(Context context, int frequency, ContentValues values) {
        return context.getContentResolver().update(
                Station.CONTENT_URI,
                values,
                Station.FREQUENCY + "=?",
    ...
    public static int updateRDSToDb(Context context,  ContentValues values) {
        return context.getContentResolver().update(
                Station.CONTENT_URI,
                values,
                null,
    ...
    /**
     * Get station name, if user rename station, we return user set station name, otherwise return
     * program service.
     * 
     * @param context The context
     * @param frequency The station frequency
    ...
    public static String getStationName(Context context, int frequency) {
        ...
        try {
            cursor = context.getContentResolver().query(
                    Station.CONTENT_URI,
                    new String[] {
                            Station.STATION_NAME, Station.PROGRAM_SERVICE
                    },
                    Station.FREQUENCY + "=?",
                    new String[] {
                        String.valueOf(frequency)
