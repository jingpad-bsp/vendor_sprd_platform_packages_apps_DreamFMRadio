...
public class FmProvider extends ContentProvider {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(
                    "CREATE TABLE " + TABLE_NAME + "("
                            ...
                            + FmStation.Station.IS_SHOW + " INTEGER DEFAULT 0,"
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        int rows = 0;
        /**
         *  bug522251, FM happends crash in high storage case. Original Android code: mSqlDb =
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mSqlDb.replace(TABLE_NAME, null, v);
        if (rowId <= 0) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        /**
         *  bug522251, FM happends crash in high storage case. Original Android code:
    ...
    /**
     * Batch operate database
     *
     * @param operations The database list
     * @return operate success result
     */
    @Override
    public ContentProviderResult[] applyBatch(ArrayList<ContentProviderOperation> operations)
        ...
        try{
            ...
            db.endTransaction();
            getContext().getContentResolver().notifyChange(FmStation.Station.CONTENT_URI, null);
        }
    }
